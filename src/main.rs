...
fn main() {
    ...
    app.add_plugins(DefaultPlugins)
        ...
        .add_plugins(EvolusjonStegPlugin{ environmentSpesificIndividStuff :  evolusjon::evolusjon_steg_plugin::PossibleBehaviorSets::LUNAR_LANDER_3D{ oppførsel: LunarLanderIndividBehaviors }})
